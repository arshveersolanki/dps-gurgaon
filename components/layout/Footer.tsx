      ...
      <div className="shell grid gap-12 py-20 md:grid-cols-12 md:py-24">
        ...
        <div className="md:col-span-3">
          ...
          <ul className="space-y-3">
            {NAV.map((item) => (
              <li key={item.key}>
                <Link href={item.href} className="font-sans text-sm text-paper/65 transition-colors hover:text-gold">
                  {t(item.key)}
                </Link>
              </li>
            ))}
        ...
        <div className="md:col-span-2">
          ...
          <ul className="space-y-3 font-sans text-sm text-paper/65">
            <li><Link href="/admissions" className="transition-colors hover:text-gold">Process</Link></li>
            <li><Link href="#admissions" className="transition-colors hover:text-gold">Fee Structure</Link></li>
            <li><Link href="#admissions" className="transition-colors hover:text-gold">Entry Points</Link></li>
            <li>
              <a href={contact.campusCare} className="transition-colors hover:text-gold">
                {t("footer.campuscare")}
              </a>
            </li>
          </ul>
